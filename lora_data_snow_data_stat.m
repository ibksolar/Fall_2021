...
base_path = '/cresis/snfs1/dataproducts/public/data/temp/internal_layers/NASA_OIB_test_files/image_files/greenland_picks_final_2009_2012_reformat/';
% base_path = '/cresis/snfs1/dataproducts/public/data/temp/internal_layers/NASA_OIB_test_files/image_files/greenland_picks_final_2009-2012_20140602/';
...
data_files = get_filenames(fullfile(base_path,base_dir(4).name),'data','20','.mat');
layer_files = get_filenames(fullfile(base_path,year),'layer','20','.mat');
